...
public class CentreManager_ViewUser extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CentreManager_ViewUser
     */
    public CentreManager_ViewUser() {
        initComponents();
        initGUI();
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("View User Records");
        ...
        tblUserRecords.setFont(new java.awt.Font("Arial", 1, 13)); // NOI18N
        tblUserRecords.setForeground(new java.awt.Color(0, 0, 0));
        tblUserRecords.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "User ID", "User Role", "Full Name", "Username", "Password", "Gender", "Date of Birth", "Phone Number", "Email", "Bank Name", "Bank Acc Num", "User Status"
            }
        ) {
        ...
        tblUserRecords.setToolTipText("");
        tblUserRecords.setSelectionBackground(new java.awt.Color(0, 51, 51));
        tblUserRecords.setSelectionForeground(new java.awt.Color(204, 255, 204));
        tblUserRecords.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblUserRecordsMouseClicked(evt);
            }
        });
    ...
    private void btnFilterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFilterActionPerformed
        ...
        if(filterTrainingRecords()){
            JOptionPane.showMessageDialog(null, "The user records has been filtered accordingly.", "Records Filtered", JOptionPane.INFORMATION_MESSAGE);
        } else{
            try {
                JOptionPane.showMessageDialog(null, "No user records were found according to the filter", "No Records", JOptionPane.ERROR_MESSAGE);
                getUserRecords();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CentreManager_ViewUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CentreManager_ViewUser().setVisible(true);
            }
        });
    }
   ...
   private void showFilterBtn(){
    ...
    public void getUserRecords() throws ParseException{
        ...
        try {
            ...
            for (int i = 0; i < tableLines.length; i++) {         
                ...
                String userid = userDataRow[0];
                String userrole = userDataRow[1];
                String userfullname = userDataRow[2];
                String userusername = userDataRow[3];
                String userpassword = userDataRow[4];
                String gender = userDataRow[5];
                Date date = dateFormat.parse(userDataRow[6]);
                String formatTableDate = dateFormatTable.format(date);
                String phonenum = userDataRow[7];
                String email = userDataRow[8];
                String status = userDataRow[9];
                String bankname = userDataRow[10];
                String banknum = userDataRow[11];
    ...
    private boolean filterTrainingRecords(){
        ...
        try {           
             File userRecords = new File(projectDir);
             BufferedReader br = new BufferedReader(new FileReader(userRecords));
             Object[] tableLines = br.lines().toArray();
             DefaultTableModel model = (DefaultTableModel)tblUserRecords.getModel();
             for(int i = 0; i < tableLines.length; i++)
                {
        ...
        try {
            ...
            addWindowListener(new WindowAdapter() {
                public void windowClosing(WindowEvent e) {
                    int selection = JOptionPane.showConfirmDialog(null, "Want to exit?", "Closing View User", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    if (selection == JOptionPane.YES_OPTION) {
